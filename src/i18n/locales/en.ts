...
export default {
  ...
  about: {
    title: 'About FaultCode',
    developer: 'Developer',
    developerName: 'Ömer Faruk BİNGÖL',
    partnerCompany: 'Partner Company',
    companyName: 'Çamlıca Teknik Servis',
    description: 'Professional boiler fault code assistant with comprehensive database and expert solutions.',
    version: 'Version',
    versionNumber: '0.1.0',
  },
  ...
  contactUs: {
    ...
    successMessage: 'Your feedback has been received. Thank you!',
    errorTitle: 'Error',
